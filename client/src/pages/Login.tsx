        ...
        <div className="bg-card border border-border rounded-2xl p-8 shadow-2xl shadow-black/40 backdrop-blur-sm bg-card/80">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <button
              ...
              className="w-full bg-primary text-primary-foreground rounded-xl py-4 font-bold text-sm shadow-lg shadow-primary/20 hover:opacity-90 active:scale-[0.98] transition-all flex items-center justify-center gap-3"
            >
